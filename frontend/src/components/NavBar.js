        ...
        <nav className="navbar navbar-expand-sm bg-light d-flex p-2">
                ...
                <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div className="navbar-nav me-auto mb-2 mb-lg-0">
                        { user && user.courses[0] && <div className='nav-item'><Link to='/' className="nav-link">Instructor View</Link></div>}
                        { user && user.isAdmin && <div className='nav-item'><Link to='/admin' className="nav-link" >Administrator View</Link></div>}
                    </div>
